    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (token != null) {
            ...
            when (role) {
                ...
                "GURU" -> startActivity(Intent(this@LoginActivity, MainGuruActivity::class.java)) // ✅ Benar!
            }
            finish()
        }
        ...
        apiService.loginUser(loginRequest).enqueue(object : Callback<LoginResponse> {
            override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                if (response.isSuccessful && response.body() != null) {
                    ...
                    when (role) {
                        "SISWA" -> startActivity(Intent(this@LoginActivity, MainActivity::class.java))
                        "GURU" -> startActivity(Intent(this@LoginActivity, MainGuruActivity::class.java)) // ✅ Disini sudah diganti ke MainGuruActivity
